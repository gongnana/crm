# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2020-06-06 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('qq', 'qq群'), ('referral', '内部转介绍'), ('website', '官方网站'), ('baidu_ads', '百度推广'), ('office_direct', '直接上门'), ('WoM', '口碑'), ('public_class', '公开课'), ('website_friends', '友链'), ('other', '其他')], default='qq', max_length=64, verbose_name='客户来源')),
                ...
                ('status', models.CharField(choices=[('singed', '已报名'), ('unregistered', '未报名'), ('studying', '学习中'), ('paid_in_full', '学费已交齐')], default='unregistered', help_text='选择客户此时的状态', max_length=64, verbose_name='状态')),
